...
namespace ee.LawyerSystem.UserControls
{
    /// <summary>
    ...
    public partial class AreaSelector : UserControl, INotifyPropertyChanged
    {
        ...
        private IList<ls.Models.Entities.Area> _provinces = new List<ls.Models.Entities.Area>();
        ...
        public IList<ls.Models.Entities.Area> Provinces
        {
            get
            {
                return _provinces;
